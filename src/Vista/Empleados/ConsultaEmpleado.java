...
public class ConsultaEmpleado extends javax.swing.JInternalFrame {
    ...
    public void consulta(String valor, String param) {
        ...
        String SQL = "select * from empleado where "+param.toLowerCase()+" like '%" + valor + "%'";
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/search-empleado.png"))); // NOI18N
