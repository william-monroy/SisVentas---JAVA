...
public class ConsultaUsuario extends javax.swing.JInternalFrame {
    ...
    public void consulta(String valor, String param) {
        ...
        String SQL = "select * from usuarios where "+param.toLowerCase()+" like '%" + valor + "%'";
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/search-user.png"))); // NOI18N
        ...
        cboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Usuario" }));
